...
namespace Landmarks.Web
{
    public class Startup
    {
        ...
        private static void ConfigServices(IServiceCollection services)
        {
            ...
            services.AddScoped<Interfaces.Admin.ICategoryService, Services.Admin.CategoryService>();
            services.AddScoped<IRegionService, RegionService>();
            services.AddScoped<IRankingService, RankingService>();
            services.AddScoped<IVisitationService, VisitationService>();
            services.AddScoped<Interfaces.Main.ICategoryService, Services.Main.CategoryService>();
